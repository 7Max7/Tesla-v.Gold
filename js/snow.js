...
function SnowStorm() { var imagePath = 'pic/show/'; var flakesMax = 12; var flakesMaxActive = 5;
 ...
 this.SnowFlake = function(parent,type,x,y) {  var s = this;  var storm = parent;  this.type = type;  this.x = x||parseInt(rnd(screenX-20));  this.y = (!isNaN(y)?y:-rnd(screenY)-12);  this.vX = null;  this.vY = null;  this.vAmpTypes = [2.0,1.0,1.25,1.0,1.5,1.75]; this.vAmp = this.vAmpTypes[this.type];  this.active = 1;  this.o = document.createElement('img');  this.o.style.position = 'absolute';  this.o.style.width = flakeWidth+'px';  this.o.style.height = flakeHeight+'px';  this.o.style.fontSize = '1px'; this.o.style.zIndex = zIndex;
  this.o.src = imagePath+this.type+(pngSupported && usePNG?'.gif':'.png');
 ...
 // выдранно специально для muz-tracker a.k.a 7Max7
 ...
 this.start = function(bFromOnLoad) {
	if (!didInit) {
	 didInit = true;
	} else if (bFromOnLoad) { return true;	}  if (typeof targetElement == 'string') {
...
snowStorm = new SnowStorm(); SnowStorm();