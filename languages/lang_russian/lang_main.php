...
class lang implements arrayaccess {
	...
	public function __construct() {
		$this->tlr = array(
			...
			'page_generated' => "Страничка сгенерирована за %f секунд, %d программистами (%s%% PHP / %s%% MySQL)",
			'unknown' => 'Неизвестно',
		...
		'my_contact_mirc' => 'Имя в mIRC!',
			...
			'my_info' => 'Информация',
			'multitracker' => 'Мульти Трекер',
			'thistracker' => 'Данный Трекер',
		//	'my_userbar' => 'Юзербар',
		//	'my_userbar_descr' => 'Это твой юзербар. Ты можешь поставить его в подписи на форуме.<br />Пользователям форума будет виден твой рейтинг на нашем трекере, а если ты еще поставишь и ссылку на наш трекер - они смогут попасть на наш трекер просто нажав на картинку.<br /><br />Вот твой <b>BB-код</b> для вставки в подпись на форумах',
			...
			'bookmarks' => 'Закладки',
			'browse' => 'Торренты',
			'browseday' => 'Сегодняшние Торренты',
			'bytes' => 'байт',
			'change' => 'Изменить',
			'choose' => 'Выберите',
			...
			'click_on_avatar' => 'Кликните здесь, чтобы перейти в настройки аккаунта',
			'comment' => 'комментарий',
	...
	//		'dox_nothing_received' => 'Ничего не получено! Возможно файл который вы пытались загрузить - слишком большой.',
			'dox_size' => 'Размер',
			'dox_time' => 'Время',
...
if (!$this->tlr[$offset]){
$sf =ROOT_PATH."cache/fix_lang.txt"; 
$fpsf=fopen($sf,"a+"); 
$date = date("d.m.y"); 
$file=basename($_SERVER['SCRIPT_FILENAME']);
$time= date("H:i:s"); 
fputs($fpsf,"$offset - $file\n"); 
fclose($fpsf);
}
