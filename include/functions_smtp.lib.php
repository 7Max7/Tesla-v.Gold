...
if (!@fsockopen($server, $port, $e, $er, 8))
{
 echo("Наcтройки -> smtp.lib.php");
}
		if ($this->_is_closed()) {
			return false;
		}
...
// Собственник этого движка - 7Max7, копия распространяется только за деньги, здесь же готовая версия трекера.
?>