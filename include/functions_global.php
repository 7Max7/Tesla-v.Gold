...
/// ЭТО КОПИРАЙТ, СНЯТИЕ ИЛИ ИЗМЕНЕНИЕ ССЫЛОК ИЛИ НИКОВ - ВЛЕЧЕТ ЧИСТКУ ДВИЖКА ПО БАЗЕ ///
define ("VERSION", "<b>.:$SITENAME <a href=\"http://www.muz-tracker.net/\" class=\"copyright\" alt=\"Сайт поднят на движке под названием Tesla Tracker (TT) © ".date("Y")." года. Владельцами являются 7Max7 и Imperator.\" title=\"Сайт поднят на движке под названием Tesla Tracker (TT) © 2010 года. Владельцами являются 7Max7 и Imperator.\"/>©</a> 2010 года v.Gold:.<b>");
define ("TBVERSION", "");
/// ЭТО КОПИРАЙТ, СНЯТИЕ ИЛИ ИЗМЕНЕНИЕ ССЫЛОК ИЛИ НИКОВ - ВЛЕЧЕТ ЧИСТКУ ДВИЖКА ПО БАЗЕ ///
