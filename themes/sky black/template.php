...
function blok_menu($title, $content , $width="155") {
	...
	<td class="block" width="100%" align="center" valign="middle" background="themes/'.$ss_uri.'/images/center_cellpic.gif"><nobr><font class="block-title" valign="bottom"><strong>'.$title.'</strong></font></nobr></td>
